...
use TravelDiary\TripBundle\Form\TripType;
...
class TripController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TDTripBundle:Trip')->findAll();

        return $this->render('TDTripBundle:Trip:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TDTripBundle:Trip:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TDTripBundle:Trip')->find($id);
        ...
        return $this->render('TDTripBundle:Trip:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TDTripBundle:Trip:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $entity->setUser($this->getUser());$em->flush();
